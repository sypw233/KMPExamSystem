...
// Premium Blue / Slate Palette (Refined MD3)
// A more sophisticated, desaturated blue providing a professional/enterprise look.
...
val md_theme_light_surfaceTint = Color(0xFF365E9D)
val md_theme_light_surfaceDim = Color(0xFFDDD8E0)
...
// Semantic colors for dialog types
val md_theme_light_info = Color(0xFF2196F3)
val md_theme_light_warning = Color(0xFFFFA726)
val md_theme_light_success = Color(0xFF4CAF50)

// Dark Palette (Premium Blue)
val md_theme_dark_primary = Color(0xFFAAC7FF)
val md_theme_dark_onPrimary = Color(0xFF002F65)
val md_theme_dark_primaryContainer = Color(0xFF1D4686)
...
val md_theme_dark_inversePrimary = Color(0xFF365E9D)
val md_theme_dark_surfaceTint = Color(0xFFAAC7FF)
val md_theme_dark_surfaceDim = Color(0xFF1A1C1E)
val md_theme_dark_surfaceBright = Color(0xFF3A3C41)
val md_theme_dark_surfaceContainerLowest = Color(0xFF0F1114)
...
// Semantic colors for dialog types (dark theme variants)
val md_theme_dark_info = Color(0xFF90CAF9)
val md_theme_dark_warning = Color(0xFFFFCC80)
